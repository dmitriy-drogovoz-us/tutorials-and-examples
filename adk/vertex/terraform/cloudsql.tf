...
locals {
  cloudsql_database_name = var.cloudsql_database_name != "" ? var.cloudsql_database_name : var.default_resource_name
...
resource "kubernetes_secret" "secret" {
  ...
  data = {
    username = var.cloudsql_database_user_name
    password = random_password.pwd.result
