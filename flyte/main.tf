...
module "infra" {
  source = "github.com/ai-on-gke/common-infra/common/infrastructure?ref=common-migrate"
...
module "gcs" {
  source      = "github.com/ai-on-gke/common-infra/common/modules/gcs?ref=common-migrate"
