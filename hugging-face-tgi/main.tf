...
module "namespace" {
  source           = "git::https://github.com/ai-on-gke/common-infra//common/modules/kubernetes-namespace"
  create_namespace = true
  namespace        = var.namespace
}

module "inference-server" {
  source            = "git::https://github.com/ai-on-gke/common-infra//common/modules/inference-service"
  namespace         = var.namespace
