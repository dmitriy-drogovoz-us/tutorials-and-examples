...
locals {
  database_name     = var.cloudsql_database_name != "" ? var.cloudsql_database_name : var.default_resource_name
  cloudsql_instance = var.cloudsql_instance != "" ? var.cloudsql_instance : var.default_resource_name
}
...
resource "kubernetes_secret" "secret" {
  provider = kubernetes.flowise
  metadata {
    name      = var.cloudsql_database_secret_name
